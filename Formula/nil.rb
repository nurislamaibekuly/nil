class Nil < Formula
  ...
  if Hardware::CPU.intel?
    url "https://github.com/nurislamaibekuly/nil/releases/download/v1.0.0/nil-macos-x86_64"
    sha256 "e475d9d3def5e2bc8397620fa9b5708456661e26c8924148daaf0163dd948b40"
  else
    url "https://github.com/nurislamaibekuly/nil/releases/download/v1.0.0/nil-macos-aarch64"
